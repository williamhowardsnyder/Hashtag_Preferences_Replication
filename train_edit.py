...
def train_mlp(mlp_model, train_dataset, valid_dataset, train_dataloader, valid_dataloader, optimizer, weights, scheduler, joint_train_flag, epoch_num):
    ...
    for epoch in range(epoch_num):
        ...
        positive_accuracy = num_correct_positive/num_positive
        ...
        train_accs.append(positive_accuracy)
        ...
        validation_accuracy = num_correct_positive/num_positive
        ...
        if total_loss < best_valid_loss:
            ...
            best_epoch = epoch
            print('Current best!')
            torch.save(mlp_model.state_dict(), f'./ModelRecords/best_model_edit{epoch}.pt')
        torch.save(mlp_model.state_dict(), f'./ModelRecords/model_edit{epoch}.pt')
