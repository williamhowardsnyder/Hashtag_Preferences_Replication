...
import argparse
from train_edit import train_mlp
    ...
    if 1:
        ...
        for i in range(1, 2):
            ...
            hyper_params = [
                ...
                {'batch_size': 256, 'lr': 1e-6},
                {'batch_size': 128, 'lr': 1e-6},
                {'batch_size': 128, 'lr': 1e-5},
            ...
            for param in hyper_params:
                ...
                train_dataloader = data.DataLoader(train_dataset, batch_size=batch_size, shuffle=True, collate_fn=my_collate, num_workers=8)
                valid_dataloader = data.DataLoader(valid_dataset, batch_size=batch_size, collate_fn=my_collate, num_workers=8)
                
                train_accuracies, val_accuracies, train_losses, val_losses = train_mlp(mlp_model, train_dataset, valid_dataset, train_dataloader, valid_dataloader, optimizer, weights, scheduler, joint_train_flag=True, epoch_num=20)   #100
            ...
            plot_acc(all_train_accuracies, all_val_accuracies, labels, 'acc.png')
            plot_loss(all_train_losses, all_val_losses, labels, 'loss.png')
